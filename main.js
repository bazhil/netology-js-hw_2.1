...
var position = 1; 
// const provider = {};
// provider.name = positions[position].producer.name;
// provider.deferPeriod = positions[position].producer.deferPeriod;
// var totalSum;
// var shippingDate = new Date(2222, 10, 10);
...
// var deferPayment = deferPay(provider, 1000, new Date(2222, 10, 10));
// console.log(`${deferPayment[0].paymentDate.getDate()}.${deferPayment[0].paymentDate.getMonth() + 1}.${deferPayment[0].paymentDate.getFullYear()}: ${deferPayment[0].producer.name}, сумма ${deferPayment[0].amount} Q`);
// console.log(deferPayment.length);
// console.log(deferPayment[0].producer);
// console.log(deferPayment[0].amount);
// console.log(deferPayment[0].paymentDate);
